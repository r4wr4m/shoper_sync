...
def test(page):
    ...
    print_pretty_json(requests.get('https://'+page[0]+'/webapi/rest/products?limit=1&page=1&filters={"product_id":7169,"translations.pl_PL.active":"1"}',headers=headers,proxies=proxies,verify=verify).text)
